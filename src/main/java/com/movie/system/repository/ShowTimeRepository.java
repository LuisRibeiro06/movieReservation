...
public interface ShowTimeRepository extends JpaRepository<ShowTime, Long> {
    ...
    @Query("SELECT DISTINCT st.movie FROM ShowTime st WHERE st.date > :date")
    List<Movie> getMoviesPlayingFromDate(LocalDateTime date);

    List<ShowTime> findByCinemaRoom(CinemaRoom cinemaRoom);
